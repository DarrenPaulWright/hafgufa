...
Object.assign(SvgControl.prototype, {
	...
	borderWidth() {
		return this.element.getBBox().width || this.element.getBoundingClientRect().width;
	},
	...
	borderHeight() {
		return this.element.getBBox().height || this.element.getBoundingClientRect().height;
	}
});
